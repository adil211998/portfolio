...
const HeroSection = () => {
    return (
        <div id='hero-section' className="grid grid-cols-2 fit-height items-center justify-center p-24 snap-center relative">
            <div>
            ...
            <div className='flex flex-col'>
                <h2 className="text-8xl text-white font-bold uppercase montserrat-font" style={{letterSpacing: "2px"}}>Creative</h2>
                <p className="text-6xl text-gray-50 my-4 heading-text font-bold uppercase montserrat-font" style={{letterSpacing: "2px"}}>Web developer.</p>
